...
--target all`, rows not already listed above). `webpki-roots` data is under the Community Data
...
| harfrust | 0.13.3 | MIT | OpenType shaping (HarfBuzz port) for the Arabic signature appearance |
...
| read-fonts | 0.43.3 | MIT OR Apache-2.0 | Font tables (metrics, cmap) for the signature appearance |
...
| font-types | 0.12.5 | MIT OR Apache-2.0 | Transitive dependency |
