//! Generated by a fontTools script (scratch tool, not shipped): PDF simple-font base encodings
//! (ISO 32000-1 Annex D) and the Adobe Glyph List (name -> first Unicode value).
//! The AGL is published by Adobe under the BSD-3-Clause licence (see THIRD-PARTY-NOTICES.md).

/// STANDARD: glyph name per code ("" = undefined).
...
/// MAC_ROMAN: glyph name per code ("" = undefined).
...
/// WIN_ANSI: glyph name per code ("" = undefined).
...
/// Adobe Glyph List (AGL 2.0 + AGLFN) names sorted by name (binary-searchable).
pub static AGL: [(&str, u32); 4281] = [
    ("A", 0x0041),
    ("AE", 0x00C6),
    ("AEacute", 0x01FC),
    ("AEmacron", 0x01E2),
